...
write_trampoline(void *target, void *dest)
{
    ...
    if (kr != KERN_SUCCESS) {
        ...
        if (mprotect((void*)page, vm_page_size,
...
static const struct { const char *sec_sym; const char *our_sym; } trust_syms[] = {
    { "SecTrustEvaluate",         "tls12_SecTrustEvaluate"         },
    { "SecTrustGetResult",         "tls12_SecTrustGetResult"         },
    { "SecTrustGetCssmResultCode", "tls12_SecTrustGetCssmResultCode" },
    { NULL, NULL }
};
