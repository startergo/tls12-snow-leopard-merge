...
/*
 * SL-BACKPORT: verbatim sys/codesign.h from apple-oss-distributions xnu
 * xnu-1504.15.3 (the Snow Leopard 10.6.8 kernel). Absent from the 10.6 SDK but
 * csops() is present in the 10.6 runtime. Staged so cskernel.cpp compiles.
 */
